...
import { GlobeIcon, MagnifyingGlassIcon, PersonIcon } from "@radix-ui/react-icons";
      ...
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 gap-3 md:gap-0">
          ...
          <div className="flex items-center gap-2 md:gap-4">
            ...
            >
               < MagnifyingGlassIcon style={{width:25,height:25}} className=" text-gray-300 "/>
